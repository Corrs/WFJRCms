...
<script src="${base}/static/plugins/ms/mstore/4.6.0/js/mstore-client.min.js"></script>	
</head>
        ...
        <div class="ms-top-user">
            <div class="dropdown">
                <div id="dLabel" class="ms-top-info" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <#if managerSession.managerNickName?has_content>${managerSession.managerNickName}<#elseif managerSession.managerName?has_content>${managerSession.managerName}<#else>${managerSession.managerId}</#if>
