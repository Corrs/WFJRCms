...
<link rel="shortcut icon" href="${base}/static/images/ms.ico"/>     
<link rel="bookmark" href="${base}/static/images/ms.icoo"/> 
<link rel="stylesheet" type="text/css" href="${base}/static/skin/manager/${manager_ui}/css/login.css" media="all" />
<link rel="stylesheet" type="text/css" href="${base}/static/skin/manager/${manager_ui}/css/reset.css">
<link rel="stylesheet" type="text/css" href="${base}/static/skin/manager/${manager_ui}/css/supersized.css">
<link rel="stylesheet" type="text/css" href="${base}/static/skin/manager/${manager_ui}/css/style.css">
<script type="text/javascript" src="${base}/static/skin/manager/${manager_ui}/js/supersized.3.2.7.min.js"></script>
<script type="text/javascript" src="${base}/static/skin/manager/${manager_ui}/js/supersized-init.js"></script>
<script type="text/javascript" src="${base}/static/skin/manager/${manager_ui}/js/scripts.js"></script>
<script>
