...
<div class="form-group ms-form-group">	
	...
	<script type="text/javascript">
	   ...
	   var ue = UE.getEditor('editor_${name}', {
       		...
       		// 服务器统一请求接口路径
       		serverUrl: URL + "jsp/msController.jsp?jsonConfig=%7BvideoUrlPrefix:'${base}',fileUrlPrefix:'${base}',imageUrlPrefix:'${base}',imagePathFormat:'/upload/editor/${appId?default(0)}/%7Btime%7D',filePathFormat:'/upload/editor/${appId}/%7Btime%7D',videoPathFormat:'/upload/editor/${appId}/%7Btime%7D'%7D", 
